...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, }, "z", function () awful.util.spawn('guake -t', {
       focus = true})
    end,
    ...
    awful.key({ }, "XF86AudioRaiseVolume",
        function ()
            ...
            --os.execute(string.format("amixer -q set %s 1%%-", alsa.channel))
            -- alsa.update()
        end,
    ...
    awful.key({  }, "XF86AudioLowerVolume",
        function ()
            awful.spawn('amixer -q sset Master 5%-')
            --os.execute(string.format("amixer -q set %s toggle", alsa.togglechannel or alsa.channel))
            --alsa.update()
        end,
    ...
    awful.key({ }, "XF86AudioMute",
        function ()
            ...
            --os.execute(string.format("amixer -q set %s 100%%", alsa.channel))
            -- alsa.update()
        end,
